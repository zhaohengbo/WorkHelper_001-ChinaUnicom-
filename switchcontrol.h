...
class SwitchControl : public QWidget
{
    ...
    Q_PROPERTY(QColor        DisbaledColor   READ       getDisbaledColor    WRITE     setDisbaledColor)
    Q_PROPERTY(QColor        ThumbColor      READ       getThumbColor       WRITE     setThumbColor)
